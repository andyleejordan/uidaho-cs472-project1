...
CFLAGS=$(LFLAGS) -c
PROGRAM=search
OBJECTS=main.o random_generator.o individual.o problem.o spherical_problem.o rosenbrock_problem.o rastrigin_problem.o schwefel_problem.o algorithm.o hill_climbing_algorithm.o simulated_annealing_algorithm.o genetic_algorithm.o
...
main.o: main.cpp random_generator.hpp spherical_problem.hpp rosenbrock_problem.hpp rastrigin_problem.hpp schwefel_problem.hpp problem.hpp hill_climbing_algorithm.hpp simulated_annealing_algorithm.hpp genetic_algorithm.hpp algorithm.hpp individual.hpp
	$(CC) $(CFLAGS) main.cpp
