...
CFLAGS=$(LFLAGS) -c
PROGRAM=search
OBJECTS=main.o individual.o problem.o spherical_problem.o algorithm.o hill_climber_algorithm.o 
...
main.o: main.cpp spherical_problem.hpp problem.hpp hill_climber_algorithm.hpp algorithm.hpp individual.hpp
	$(CC) $(CFLAGS) main.cpp
